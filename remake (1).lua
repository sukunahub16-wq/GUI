...
local redzlib = {
	Themes = {
		Darker = {
			...
			["Color Text"] = Color3.fromRGB(139, 69, 19),
			["Color Dark Text"] = Color3.fromRGB(139, 69, 19)
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
		...
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(139, 69, 19))
			}),
			["Color Hub 2"] = Color3.fromRGB(90, 60, 30),
			["Color Stroke"] = Color3.fromRGB(110, 70, 40),
			["Color Theme"] = Color3.fromRGB(160, 82, 45),
			["Color Text"] = Color3.fromRGB(245, 222, 179),
			["Color Dark Text"] = Color3.fromRGB(210, 180, 140),
			["Color Dark Purple"] = Color3.fromRGB(139, 69, 19),
			["Color Hub 9"] = Color3.fromRGB(60, 40, 20),
			["Color Dark Greem"] = Color3.fromRGB(101, 67, 33)
		}
	},
	Info = {
		Version = "1.2.0"
...
local function SpawnCyberpunkSystem()
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "اغلاق",
			Text = "متاكد تريد تغلق سكربتي بزعل منك على فكرة يلا خلي سكربت عمو اسماعيل يحبك",
			Options = {
				{"تأكيد", function()
					ScreenGui:Destroy()
				end},
